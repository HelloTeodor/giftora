        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            <Link href="/" className="block mb-4">
              <span className="font-serif text-2xl font-bold tracking-[0.04em] text-white">Giftora</span>
              <span className="block text-[10px] italic text-navy-400 font-light tracking-wide mt-0.5">Thoughtful Gift Boxes &amp; Sets</span>
            </Link>
